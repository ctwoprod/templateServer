...
import template.app.report.command.workbook.TestWorkbook;
...
public class RptTestXlsCommand extends ReportCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<Login> listLogin = loginDao.findAll(null);

		Object[] pnsArray = listLogin.toArray();

		excelMap.put(TEMPLATE, reportBaseDir + "rptTest.xls");
		excelMap.put(REPORT_TYPE, "XLS");
		excelMap.put("PARAM_1", "XLS ini param 1");
		excelMap.put("PARAM_2", "ini param 2 XLS");
		excelMap.put(START_INDEX, Integer.valueOf(INT_START_INDEX));
		excelMap.put(FORMAT, "NCCCCCCCCCCCCCCCCC");
