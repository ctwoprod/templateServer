package template.app.core.persistence.dao;
 ...
 * @author Roberto
 */
public interface CoreDao<T extends CoreDomain> extends FindLayerDao<T> {
	 ...
	 * @see template.app.core.persistence.tools.PropCriteriaAndValue
	 */
