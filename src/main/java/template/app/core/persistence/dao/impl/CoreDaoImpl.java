package template.app.core.persistence.dao.impl;
...
import template.app.core.persistence.exception.CoreExceptionText;
import template.app.core.persistence.exception.CorePersistenceException;
import template.app.core.persistence.tools.PaginationResult;
import template.app.core.persistence.tools.PropCriteriaAndValue;
import template.app.core.persistence.tools.QueryOrder;
import template.app.core.util.SqlUtil;
 ...
 * @param <T>
 *            the generic type
 * @see template.app.core.persistence.domain.CoreDomain
 * @see template.app.core.persistence.domain.CoreDao
 * @author Roberto
 */
public abstract class CoreDaoImpl<T extends CoreDomain> extends
	 ...
	 *            annotation
	 */
	public CoreDaoImpl(Class<? extends CoreDomain> clazz,
