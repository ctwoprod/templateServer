...
import template.app.core.persistence.dao.CriteriaLayerDao;
...
import template.app.core.persistence.tools.QueryOrderDirection;

/**
 * @author Roberto
 * 
 */
public class CriteriaLayerDaoImpl<T extends CoreDomain> extends
	 ...
	 *            annotation
	 */
	public CriteriaLayerDaoImpl(Class<? extends CoreDomain> clazz,
