...
import template.app.core.persistence.dao.KernelDao;
...
public class KernelDaoImpl<T extends CoreDomain> implements KernelDao<T> {
	...
	/** The clazz. */
	protected final Class<? extends CoreDomain> clazz;
	...
	public KernelDaoImpl(Class<? extends CoreDomain> clazz,
